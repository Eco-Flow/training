...
| :--: | :----- | :--- | :------------- |
| **0** | [Setup](./docs/setup.md) | Practical | Get your environment ready with GitHub Codespaces, so you can run everything from your browser. |
...
| **7** | [Running a pipeline on an HPC](./docs/hpc.md) | Practical · optional | Run an nf-core pipeline on a Slurm/SGE cluster that's already set up — get the pipeline, submit and watch jobs, keep Nextflow alive, and avoid the common gotchas. Practise on a mini Slurm cluster in Codespaces. |
...
3. Begin with **[Part 0 · Setup](./docs/setup.md)**.
