...
[**Part 0.**](./docs/setup.md) Setup for the course (practical - bash)

[**Part 1.**](./docs/commandline.md) Command line basics (practical)

[**Part 2.**](./docs/pipelines.md) Pipeline lecture (with Nextflow)

[**Part 3.**](./docs/nfcore_rnaseq.md) Run an nf-core RNA-Seq pipeline (practical - nextflow)

[**Part 3 (Nanopore track).**](./docs/nanopore_metabarcoding.md) Run the nanopore metabarcoding pipeline (practical - nextflow)

[**Part 4.**](./docs/differential.md) Run differential expression analysis (!!!!TO BE COMPLETED!!!! practical - R)
