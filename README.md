...
| **4** | [Differential expression](./eco-flow-training/docs/differential.md) | Practical · R · 🚧 draft | Analyse the gene counts from Part 3 with DESeq2 to find differentially expressed genes. |
| **★** | [Running a pipeline on an HPC](./eco-flow-training/docs/hpc.md) | Bonus · optional | Configure and run the pipeline on a Slurm/SGE cluster — talk to your admin, adapt a config, and test it. |
